...
class Solution {
    ...
    function minScore($n, $roads) {
        ...
        foreach ($roads as $key => $value) {
            if ($value[2] < $minScore) $minScore = $value[2];
        }
        return $minScore;
    }
}
